...
class IssuesTable(models.Model):
    ...
    issue_repoter = models.CharField(max_length=100, blank=True, null=True)
    issue_type = models.CharField(max_length=100)
    issue_assignee = models.CharField(max_length=100)
    issue_status = models.CharField(max_length=100)
    project_title = models.ForeignKey('ProjectsTable', models.DO_NOTHING, db_column='project_title')
